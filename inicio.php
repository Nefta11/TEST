...
while ($result = $ejecutar->fetch_array()) {
    ...
    if ($result['status'] == 1) {
        ...
        while ($result2 = $ejecutar2->fetch_array()) {
            ...
            echo "<p>Fecha Ingreso: " . $result2['fechaingreso'] . " " . $result2['horaingreso'] . "</p>";
            echo "<p>Tarifa: " . $result2['monto'] . "</p>";
            echo "<p>Nombre: " . $result2['nombre'] . "</p>";
            echo "<a href='#' class='btn btn-warning' onclick='abrirModal(" . $result2['id_cajon'] . ")' >Salir</a>";
        }
    } else {
